"""autogenerated by genmsg_py from dirantenna_communicationResult.msg. Do not edit."""
import roslib.message
import struct


class dirantenna_communicationResult(roslib.message.Message):
  _md5sum = "85ecd3f2dd4a1ba8095b2bc3ed3c52d0"
  _type = "dirantenna_communication_actionserver/dirantenna_communicationResult"
...
"""
  __slots__ = ['success','strId_Mote','rssCount_Mote','rssVals']
  _slot_types = ['bool','string[]','uint16[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       success,strId_Mote,rssCount_Mote,rssVals
    ...
    """
    if args or kwds:
      super(dirantenna_communicationResult, self).__init__(*args, **kwds)
