...
public class StartApplication extends MIDlet { 
    ...
    public void init()throws IOException {
        ...
        IStream  = RadioDataIOStream.openInput(estComm.BASE_ID, 100);  // open the inpout Stream to the base.
     ...
     public void ExecuteLoop() throws IOException{      
        ...
        while(true){
            ...
            if(DirCmd > 2 && DirCmd < 7) { // If the Direction command is any of FORWARD, REVERSE, LEFT or RIGHT.
