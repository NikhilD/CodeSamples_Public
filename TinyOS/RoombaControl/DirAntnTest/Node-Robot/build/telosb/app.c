...
typedef TMilli NodeC__Timer0__precision_tag;
typedef TMilli NodeC__Timer1__precision_tag;
...
static void NodeC__Timer0__fired(void );
# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static void NodeC__Boot__booted(void );
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void NodeC__uartSendTask__runTask(void );
...
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void NodeC__Timer1__fired(void );
...
static void NodeC__HplMsp430Interrupt__fired(void );
# 4 "../../newUART/UARTByteString.nc"
static void NodeC__UARTByteString__reqGranted(error_t error);





static void NodeC__UARTByteString__receiveByteDone(uint8_t data, error_t error);
#line 9
static void NodeC__UARTByteString__sendByteDone(error_t error);
#line 7
static void NodeC__UARTByteString__sendStringDone(error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void NodeC__avgCalculationTask__runTask(void );
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
static error_t /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
static void /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 85
message_t * msg, 
...
# 81 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static bool NodeC__Timer0__isRunning(void );
#line 62
static void NodeC__Timer0__startOneShot(uint32_t dt);




static void NodeC__Timer0__stop(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t NodeC__uartSendTask__postTask(void );
...
uint8_t len);
#line 95
static uint8_t NodeC__Packet__maxPayloadLength(void );
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
uint8_t len);
# 56 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Packet.nc"
static void NodeC__CC2420Packet__setPower(message_t *p_msg, uint8_t power);
...
static int8_t NodeC__CC2420Packet__getRssi(message_t *p_msg);
...
static uint8_t NodeC__CC2420Packet__getLqi(message_t *p_msg);
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t NodeC__RadioControl__start(void );
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void NodeC__Timer1__startOneShot(uint32_t dt);
# 41 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430Interrupt.nc"
static void NodeC__HplMsp430Interrupt__clear(void );
#line 36
static void NodeC__HplMsp430Interrupt__disable(void );
#line 31
static void NodeC__HplMsp430Interrupt__enable(void );
# 8 "../../newUART/UARTByteString.nc"
static error_t NodeC__UARTByteString__sendByte(uint8_t data);
#line 3
static error_t NodeC__UARTByteString__request(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void NodeC__Leds__led0Toggle(void );
#line 72
static void NodeC__Leds__led1Toggle(void );
#line 89
static void NodeC__Leds__led2Toggle(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t NodeC__avgCalculationTask__postTask(void );
# 38 "NodeC.nc"
enum NodeC____nesc_unnamed4314 {
#line 38
  NodeC__avgCalculationTask = 0U
};
#line 38
typedef int NodeC____nesc_sillytask_avgCalculationTask[NodeC__avgCalculationTask];
#line 59
enum NodeC____nesc_unnamed4315 {
#line 59
  NodeC__uartSendTask = 1U
};
#line 59
typedef int NodeC____nesc_sillytask_uartSendTask[NodeC__uartSendTask];
#line 23
int8_t NodeC__GBL_dBmVal[300];
float NodeC__GBL_pgVal[300];
uint8_t NodeC__netID = 5;
#line 25
uint8_t NodeC__GBL_lQi[300];
#line 25
uint8_t NodeC__GBL_srcNode;
#line 25
uint8_t NodeC__GBL_UartBuf[300];
#line 25
uint8_t NodeC__GBL_uartPtr = 0;
uint8_t NodeC__GBL_uartInfo = 0;
#line 26
uint8_t NodeC__GBL_XmitCnt = 100;
#line 26
uint8_t NodeC__numPktsInfo = 0;
int16_t NodeC__guideCtr = 0;
#line 27
int16_t NodeC__msgCtr = 0;
message_t NodeC__packet;
bool NodeC__locked = FALSE;
#line 29
bool NodeC__doNothing = FALSE;


static inline void NodeC__SendtoBase(void );
static inline void NodeC__CommSendUART(uint8_t data);
static void NodeC__clearDataBuffer(void );



static inline void NodeC__avgCalculationTask__runTask(void );
#line 59
static inline void NodeC__uartSendTask__runTask(void );
#line 73
static inline void NodeC__CommSendUART(uint8_t data);
...
#line 195
static inline void NodeC__RadioControl__startDone(error_t err);
#line 207
static void NodeC__UARTByteString__sendByteDone(error_t error);
#line 224
static inline void NodeC__HplMsp430Interrupt__fired(void );
...
static inline void NodeC__Timer1__fired(void );





static inline void NodeC__UARTByteString__receiveByteDone(uint8_t byte, error_t error);
...
static inline void NodeC__RadioControl__stopDone(error_t err);
static inline void NodeC__UARTByteString__reqGranted(error_t error);
static inline void NodeC__UARTByteString__sendStringDone(error_t error);
# 31 "/opt/tinyos-2.x/tos/interfaces/GeneralIO.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 56
message_t * msg, 
...
static void /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 147
message_t * amsg, 
...
static inline error_t /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
#line 42
  UARTByteStringC__sendDoneSuccessTask = 16U
};
#line 42
...
#line 51
  UARTByteStringC__sendDoneFailTask = 17U
};
#line 51
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x7dc56b38){
#line 55
  switch (arg_0x7dc56b38) {
#line 55
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x7dc56b38);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x7dda4030){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x7dda4030) {
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x7dda4030);
#line 110
      break;
#line 110
    }
...
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x7d9242e8, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x7d9242e8, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x7dda4030){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x7dda4030);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x7dda4a80){
#line 39
  union __nesc_unnamed4285 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x7dda4a80);
#line 39
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x7dc56b38){
#line 49
  switch (arg_0x7dc56b38) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x7dc56b38);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x7dc57770){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x7dc57770);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x7dda4030){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x7dda4030);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x7dc57770){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x7dc57770);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x7dda4030){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x7dda4030);
#line 78
      break;
#line 78
    }
...
#line 4
  NodeC__UARTByteString__reqGranted(error);
#line 4
}
#line 4
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x7d889620){
#line 92
  switch (arg_0x7d889620) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x7d889620);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x7dc60cf0){
#line 92
  switch (arg_0x7dc60cf0) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x7dc60cf0);
#line 92
      break;
#line 92
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x7d8836c0){
#line 39
  union __nesc_unnamed4289 *__nesc_result;
#line 39

#line 39
  switch (arg_0x7d8836c0) {
#line 39
    case /*UARTByteStringConfig.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x7d8836c0);
#line 39
      break;
#line 39
    }
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x7dc56b38){
#line 49
  switch (arg_0x7dc56b38) {
#line 49
    case /*UARTByteStringConfig.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x7dc56b38);
#line 49
      break;
#line 49
    }
...
#line 9
  NodeC__UARTByteString__sendByteDone(error);
#line 9
}
#line 9
# 248 "NodeC.nc"
...
#line 7
  NodeC__UARTByteString__sendStringDone(error);
#line 7
}
#line 7
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x7d884bb0){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  switch (arg_0x7d884bb0) {
#line 118
    case /*UARTByteStringConfig.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x7d884bb0);
#line 118
      break;
#line 118
    }
...
inline static void NodeC__Leds__led2Toggle(void ){
#line 89
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x7d975010){
#line 92
  switch (arg_0x7d975010) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x7d975010);
#line 92
      break;
#line 92
    }
...
# 59 "/opt/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x7d925c58, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x7d925c58, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x7d9242e8, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x7d9242e8, msg);
#line 95
}
#line 95
...
# 81 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static bool NodeC__Timer0__isRunning(void ){
#line 81
  unsigned char __nesc_result;
#line 81
...
inline static void NodeC__Timer0__stop(void ){
#line 67
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void NodeC__Timer0__startOneShot(uint32_t dt){
#line 62
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x7d926258, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x7d926258, msg, payload, len);
#line 67
...
#line 72
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t NodeC__avgCalculationTask__postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(NodeC__avgCalculationTask);
#line 56
...
inline static uint8_t NodeC__CC2420Packet__getLqi(message_t *p_msg){
#line 72
  unsigned char __nesc_result;
#line 72
...
inline static int8_t NodeC__CC2420Packet__getRssi(message_t *p_msg){
#line 64
...
#line 127
  ...
  if (NodeC__guideCtr >= 300 && type == 2) {
      return bufPtr;
    }
  switch (type) {
      case 2: 
        if (!NodeC__doNothing) {
            NodeC__GBL_srcNode = __nesc_ntoh_uint8(rsm->srcNode.data);
            gp = __nesc_ntoh_uint8(rsm->srcGP.data);
            id = __nesc_ntoh_uint8(rsm->srcID.data);
            if (gp == 1 && id == NodeC__netID) {
                temp = __nesc_ntoh_uint32(rsm->pgVal.data);
                NodeC__GBL_pgVal[NodeC__guideCtr] = * (float *)&temp;
                NodeC__GBL_dBmVal[NodeC__guideCtr] = NodeC__CC2420Packet__getRssi(bufPtr);
                NodeC__GBL_lQi[NodeC__guideCtr] = NodeC__CC2420Packet__getLqi(bufPtr);
                NodeC__msgCtr = __nesc_ntoh_uint8(rsm->numMsgs.data);
                NodeC__guideCtr++;
              }
          }
      ...
      case 4: 
        gp = __nesc_ntoh_uint8(rsm->srcGP.data);
      id = __nesc_ntoh_uint8(rsm->srcID.data);
      dest = __nesc_ntoh_uint8(rsm->srcNode.data);
      NodeC__guideCtr = 0;
      if (gp == 2 && id == 0 && dest == 5) {
          NodeC__Leds__led0Toggle();
          NodeC__GBL_uartInfo = __nesc_ntoh_uint8(rsm->lQi.data);
          NodeC__avgCalculationTask__postTask();
        }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x7d927ba8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x7d927ba8) {
#line 67
    case 9:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x7d927ba8, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x7dda72a8){
#line 92
  switch (arg_0x7dda72a8) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x7dda72a8);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x7dc60cf0){
#line 92
  switch (arg_0x7dc60cf0) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x7dc60cf0);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x7dda6820, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x7dda6820) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x7dda6820, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x7de93828, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x7de93828) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x7de93828, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x7d9242e8, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x7d9242e8, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x7de93828, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x7de93828) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x7de93828, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x7de97db8){
#line 92
  switch (arg_0x7de97db8) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x7de97db8);
#line 92
      break;
#line 92
    }
...
#line 89
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x7d9271e8, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7d9271e8, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__requested(uint8_t arg_0x7dc57770){
#line 43
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__requested(arg_0x7dc57770);
#line 43
}
#line 43
# 77 "/opt/tinyos-2.x/tos/system/ArbiterP.nc"
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__request(uint8_t arg_0x7d884bb0){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__request(arg_0x7d884bb0);
#line 78
      break;
#line 78
    }
...
inline static error_t NodeC__UARTByteString__request(void ){
#line 3
  unsigned char __nesc_result;
#line 3
...
# 31 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430Interrupt.nc"
inline static void NodeC__HplMsp430Interrupt__enable(void ){
#line 31
...
#line 197
  if (err == SUCCESS) {
      NodeC__clearDataBuffer();
      NodeC__HplMsp430Interrupt__enable();
      Err = NodeC__UARTByteString__request();
      if (Err == SUCCESS) {
          NodeC__Leds__led0Toggle();
        }
    }
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 99
...
#line 57
{
  /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7e238d90, message_t * msg, error_t error){
#line 89
  switch (arg_0x7e238d90) {
#line 89
    case 0U:
#line 89
      /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7e238d90, msg, error);
#line 89
      break;
#line 89
    }
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7e234790, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x7e234790, addr, msg, len);
#line 69
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
inline static void /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 9);
  return /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}
...
#line 69
  __nesc_result = /*NodeConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 69
...
# 56 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Packet.nc"
inline static void NodeC__CC2420Packet__setPower(message_t *p_msg, uint8_t power){
#line 56
...
inline static uint8_t NodeC__Packet__maxPayloadLength(void ){
#line 95
  unsigned char __nesc_result;
#line 95
...
# 115 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
inline static void * NodeC__Packet__getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 80
  * (float *)&pgVal = NodeC__GBL_pgVal[NodeC__guideCtr];
  if (NodeC__locked) {
#line 81
      return;
    }
...
#line 84
      rsm = (radio_msg_t *)NodeC__Packet__getPayload(&NodeC__packet, sizeof(radio_msg_t ));
      if (rsm == (void *)0) {
          return;
        }
      if (NodeC__Packet__maxPayloadLength() < sizeof(radio_msg_t )) {
#line 88
          return;
        }
#line 89
      __nesc_hton_uint8(rsm->msgType.data, 3);
      __nesc_hton_uint8(rsm->srcNode.data, NodeC__GBL_srcNode);
      ...
      __nesc_hton_int8(rsm->dBmVal.data, NodeC__GBL_dBmVal[NodeC__guideCtr]);
      __nesc_hton_uint8(rsm->lQi.data, NodeC__GBL_lQi[NodeC__guideCtr]);
      __nesc_hton_uint8(rsm->numMsgs.data, NodeC__guideCtr);
      NodeC__CC2420Packet__setPower(&NodeC__packet, 31);
      if (NodeC__AMSend__send(0, &NodeC__packet, sizeof(radio_msg_t )) == SUCCESS) {
#line 99
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 99
            {
...
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t NodeC__uartSendTask__postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(NodeC__uartSendTask);
#line 56
...
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7e2dad90){
#line 72
  switch (arg_0x7e2dad90) {
#line 72
    case 0U:
#line 72
      NodeC__Timer0__fired();
#line 72
      break;
#line 72
    case 1U:
#line 72
      NodeC__Timer1__fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7e2dad90);
#line 72
      break;
#line 72
    }
...
# 8 "../../newUART/UARTByteString.nc"
inline static error_t NodeC__UARTByteString__sendByte(uint8_t data){
#line 8
  unsigned char __nesc_result;
#line 8
...
#line 75
  error = NodeC__UARTByteString__sendByte(data);
}
...
#line 59
{
  while (NodeC__guideCtr >= 0) {
      NodeC__guideCtr--;
      NodeC__GBL_UartBuf[NodeC__guideCtr] = NodeC__GBL_dBmVal[NodeC__guideCtr];
    }



  NodeC__GBL_uartPtr = 0;
  NodeC__CommSendUART(NodeC__GBL_UartBuf[0]);
}
...
#line 38
{
  NodeC__numPktsInfo = (NodeC__GBL_uartInfo & 0xF0) >> 4;
  switch (NodeC__numPktsInfo) {
      case 1: 
        NodeC__GBL_XmitCnt = 25;
      break;
      case 2: 
        NodeC__GBL_XmitCnt = 50;
      break;
      case 3: 
        NodeC__GBL_XmitCnt = 100;
      break;
      case 4: 
        NodeC__GBL_XmitCnt = 150;
      break;
      case 5: 
        NodeC__GBL_XmitCnt = 200;
      break;
    }
}
...
# 41 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430Interrupt.nc"
inline static void NodeC__HplMsp430Interrupt__clear(void ){
#line 41
...
# 36 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430Interrupt.nc"
inline static void NodeC__HplMsp430Interrupt__disable(void ){
#line 36
...
#line 224
{
  NodeC__HplMsp430Interrupt__disable();
  NodeC__HplMsp430Interrupt__clear();

  NodeC__Timer1__startOneShot(500);
}

# 61 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430Interrupt.nc"
inline static void HplMsp430InterruptP__Port27__fired(void ){
#line 61
  NodeC__HplMsp430Interrupt__fired();
#line 61
}
#line 61
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x7dc8d3d0, uint8_t data){
#line 54
  switch (arg_0x7dc8d3d0) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x7dc8d3d0, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0x7dc8dc50){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0x7dc8dc50);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x7dc8d3d0){
#line 49
  switch (arg_0x7dc8d3d0) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x7dc8d3d0);
#line 49
      break;
#line 49
    }
...
#line 10
  NodeC__UARTByteString__receiveByteDone(data, error);
#line 10
}
#line 10
...
# 79 "/opt/tinyos-2.x/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x7d8857e8, uint8_t byte){
#line 79
  switch (arg_0x7d8857e8) {
#line 79
    case /*UARTByteStringConfig.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x7d8857e8, byte);
#line 79
      break;
#line 79
    }
...
# 99 "/opt/tinyos-2.x/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x7d8857e8, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x7d8857e8) {
#line 99
    case /*UARTByteStringConfig.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x7d8857e8, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x7dc8d3d0, uint8_t data){
#line 54
  switch (arg_0x7dc8d3d0) {
#line 54
    case /*UARTByteStringConfig.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x7dc8d3d0, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x7d8857e8, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x7d8857e8) {
#line 57
    case /*UARTByteStringConfig.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x7d8857e8, buf, len, error);
#line 57
      break;
#line 57
    }
...
# 49 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x7dc8d3d0){
#line 49
  switch (arg_0x7dc8d3d0) {
#line 49
    case /*UARTByteStringConfig.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x7dc8d3d0);
#line 49
      break;
#line 49
    }
...
#line 64
    case NodeC__avgCalculationTask:
#line 64
      NodeC__avgCalculationTask__runTask();
#line 64
      break;
#line 64
    case NodeC__uartSendTask:
#line 64
      NodeC__uartSendTask__runTask();
#line 64
      break;
#line 64
...
#line 213
        __nesc_atomic_end(__nesc_atomic); }
#line 213
      if (NodeC__GBL_uartPtr >= NodeC__GBL_XmitCnt) {
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 214
            {
#line 214
...
#line 217
        {
          NodeC__CommSendUART(NodeC__GBL_UartBuf[NodeC__GBL_uartPtr]);
        }
      NodeC__Leds__led2Toggle();
    }
}
...
#line 105
    {
      for (i = 0; i < 300; i++) {
          NodeC__GBL_UartBuf[i] = 0;
          NodeC__GBL_pgVal[i] = -1000;
          NodeC__GBL_dBmVal[i] = -128;
          NodeC__GBL_lQi[i] = 0;
        }
    }
#line 112
...
#line 178
{
  if (&NodeC__packet == bufPtr) {
      ...
      NodeC__locked = FALSE;
      NodeC__guideCtr--;
      if (NodeC__guideCtr < 0) {
          NodeC__guideCtr = 0;


          NodeC__HplMsp430Interrupt__enable();
          if (NodeC__Timer0__isRunning()) {
#line 188
              NodeC__Timer0__stop();
            }
        }
...
#line 189
        {
          NodeC__Timer0__startOneShot(50);
        }
    }
}
