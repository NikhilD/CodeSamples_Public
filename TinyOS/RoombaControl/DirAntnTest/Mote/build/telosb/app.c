...
typedef TMilli MoteC__Timer0__precision_tag;
typedef TMilli MoteC__Timer1__precision_tag;
...
enum /*UARTByteStringConfig.UartC*/Msp430Uart1C__0____nesc_unnamed4310 {
...
enum /*UARTByteStringConfig.UartC.UsartC*/Msp430Usart1C__0____nesc_unnamed4311 {
...
static void MoteC__Timer0__fired(void );
# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static void MoteC__Boot__booted(void );
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void MoteC__uartSendTask__runTask(void );
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void MoteC__AMSend__sendDone(
#line 92
message_t * msg, 
...
static void MoteC__RadioControl__startDone(error_t error);
#line 117
static void MoteC__RadioControl__stopDone(error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void MoteC__sendNetTask__runTask(void );
#line 64
static void MoteC__stopGuideTask__runTask(void );
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void MoteC__Timer1__fired(void );
...
static void MoteC__HplMsp430Interrupt__fired(void );
# 4 "../../newUART/UARTByteString.nc"
static void MoteC__UARTByteString__reqGranted(error_t error);





static void MoteC__UARTByteString__receiveByteDone(uint8_t data, error_t error);
#line 9
static void MoteC__UARTByteString__sendByteDone(error_t error);
#line 7
static void MoteC__UARTByteString__sendStringDone(error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void MoteC__robotGuideTask__runTask(void );
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
static error_t /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
static void /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 85
message_t * msg, 
...
# 81 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static bool MoteC__Timer0__isRunning(void );
#line 62
static void MoteC__Timer0__startOneShot(uint32_t dt);




static void MoteC__Timer0__stop(void );
...
uint8_t len);
#line 95
static uint8_t MoteC__Packet__maxPayloadLength(void );
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t MoteC__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 56 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Packet.nc"
static void MoteC__CC2420Packet__setPower(message_t *p_msg, uint8_t power);
...
static int8_t MoteC__CC2420Packet__getRssi(message_t *p_msg);
...
static uint8_t MoteC__CC2420Packet__getLqi(message_t *p_msg);
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t MoteC__RadioControl__start(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t MoteC__sendNetTask__postTask(void );
#line 56
static error_t MoteC__stopGuideTask__postTask(void );
# 81 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static bool MoteC__Timer1__isRunning(void );
#line 53
static void MoteC__Timer1__startPeriodic(uint32_t dt);
...
static void MoteC__Timer1__startOneShot(uint32_t dt);




static void MoteC__Timer1__stop(void );
# 41 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430Interrupt.nc"
static void MoteC__HplMsp430Interrupt__clear(void );
#line 36
static void MoteC__HplMsp430Interrupt__disable(void );
# 8 "../../newUART/UARTByteString.nc"
static error_t MoteC__UARTByteString__sendByte(uint8_t data);
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void MoteC__Leds__led0Toggle(void );
#line 72
static void MoteC__Leds__led1Toggle(void );
#line 89
static void MoteC__Leds__led2Toggle(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t MoteC__robotGuideTask__postTask(void );
# 44 "MoteC.nc"
enum MoteC____nesc_unnamed4314 {
#line 44
  MoteC__sendNetTask = 0U
};
#line 44
typedef int MoteC____nesc_sillytask_sendNetTask[MoteC__sendNetTask];




enum MoteC____nesc_unnamed4315 {
#line 49
  MoteC__robotGuideTask = 1U
};
#line 49
typedef int MoteC____nesc_sillytask_robotGuideTask[MoteC__robotGuideTask];
#line 91
enum MoteC____nesc_unnamed4316 {
#line 91
  MoteC__stopGuideTask = 2U
};
#line 91
typedef int MoteC____nesc_sillytask_stopGuideTask[MoteC__stopGuideTask];




enum MoteC____nesc_unnamed4317 {
#line 96
  MoteC__uartSendTask = 3U
};
#line 96
typedef int MoteC____nesc_sillytask_uartSendTask[MoteC__uartSendTask];
#line 23
uint8_t MoteC__UartBuf[100];
#line 23
uint8_t MoteC__uartPtr = 0;
#line 23
uint8_t MoteC__selfHC = 250;
#line 23
uint8_t MoteC__doFlag1 = 0;
#line 23
uint8_t MoteC__doFlag2 = 0;


uint8_t MoteC__GBL_info;
#line 26
uint8_t MoteC__GBL_XmitCnt = 100;
#line 26
uint8_t MoteC__numPktsInfo;
#line 26
uint8_t MoteC__pktTimeInfo;
int16_t MoteC__guideCtr = 0;
uint16_t MoteC__GBL_intpktTime = 500;
float MoteC__newselfPG = 0;
#line 29
float MoteC__selfPG = 0.0;
message_t MoteC__packet;
bool MoteC__locked = FALSE;



static inline void MoteC__CommSendUART(uint8_t data);

static inline void MoteC__doPGCalculation(float arg_0x7e609010, int8_t arg_0x7e6091a8);
static inline float MoteC__scaleValues(float arg_0x7e609738, float arg_0x7e609890, float arg_0x7e6099e8);
static inline void MoteC__SendtoNetwork(uint8_t arg_0x7e609ee0);




static inline void MoteC__sendNetTask__runTask(void );




static inline void MoteC__robotGuideTask__runTask(void );
#line 91
static inline void MoteC__stopGuideTask__runTask(void );




static inline void MoteC__uartSendTask__runTask(void );
#line 108
static inline void MoteC__CommSendUART(uint8_t data);
...
static inline void MoteC__doPGCalculation(float pgVal, int8_t dBmVal);





static inline float MoteC__scaleValues(float inVal, float omax, float omin);
#line 132
static inline void MoteC__SendtoNetwork(uint8_t type);
#line 167
static inline void MoteC__Boot__booted(void );



static inline void MoteC__Timer0__fired(void );
...
static inline message_t *MoteC__Receive__receive(message_t *bufPtr, void *payload, uint8_t len);
#line 242
static void MoteC__AMSend__sendDone(message_t *bufPtr, error_t error);
...
static inline void MoteC__Timer1__fired(void );
#line 274
static inline void MoteC__RadioControl__startDone(error_t err);
...
static inline void MoteC__HplMsp430Interrupt__fired(void );
...
static inline void MoteC__RadioControl__stopDone(error_t err);
static inline void MoteC__UARTByteString__sendByteDone(error_t error);
static inline void MoteC__UARTByteString__sendStringDone(error_t error);
static inline void MoteC__UARTByteString__receiveByteDone(uint8_t byte, error_t error);
static inline void MoteC__UARTByteString__reqGranted(error_t error);
# 31 "/opt/tinyos-2.x/tos/interfaces/GeneralIO.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 56
message_t * msg, 
...
static void /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 147
message_t * amsg, 
...
static inline error_t /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
enum UARTByteStringC____nesc_unnamed4358 {
#line 42
...
enum UARTByteStringC____nesc_unnamed4359 {
#line 51
...
#line 76
static inline error_t UARTByteStringC__UARTByteString__sendByte(uint8_t data);
#line 89
...
static inline uint8_t /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__isOwner(uint8_t id);
#line 187
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x7dc4ab38){
#line 55
  switch (arg_0x7dc4ab38) {
#line 55
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x7dc4ab38);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x7dd8f030){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x7dd8f030) {
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x7dd8f030);
#line 110
      break;
#line 110
    }
...
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x7d9162e8, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x7d9162e8, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x7dd8f030){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x7dd8f030);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x7dd8fa80){
#line 39
  union __nesc_unnamed4285 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x7dd8fa80);
#line 39
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x7dc4ab38){
#line 49
  switch (arg_0x7dc4ab38) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x7dc4ab38);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x7dc4b770){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x7dc4b770);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x7dd8f030){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x7dd8f030);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x7dc4b770){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x7dc4b770);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x7dd8f030){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x7dd8f030);
#line 78
      break;
#line 78
    }
...
#line 4
  MoteC__UARTByteString__reqGranted(error);
#line 4
}
#line 4
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x7d879388){
#line 92
  switch (arg_0x7d879388) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x7d879388);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x7dc4ccf0){
#line 92
  switch (arg_0x7dc4ccf0) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x7dc4ccf0);
#line 92
      break;
#line 92
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x7d876420){
#line 39
  union __nesc_unnamed4289 *__nesc_result;
#line 39

#line 39
  switch (arg_0x7d876420) {
#line 39
    case /*UARTByteStringConfig.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x7d876420);
#line 39
      break;
#line 39
    }
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x7dc4ab38){
#line 49
  switch (arg_0x7dc4ab38) {
#line 49
    case /*UARTByteStringConfig.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x7dc4ab38);
#line 49
      break;
#line 49
    }
...
#line 9
  MoteC__UARTByteString__sendByteDone(error);
#line 9
}
#line 9
# 296 "MoteC.nc"
...
#line 7
  MoteC__UARTByteString__sendStringDone(error);
#line 7
}
#line 7
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x7d969010){
#line 92
  switch (arg_0x7d969010) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x7d969010);
#line 92
      break;
#line 92
    }
...
# 59 "/opt/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x7d917c58, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x7d917c58, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x7d9162e8, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x7d9162e8, msg);
#line 95
}
#line 95
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x7d918258, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x7d918258, msg, payload, len);
#line 67
...
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void MoteC__Leds__led0Toggle(void ){
#line 56
...
#line 56
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t MoteC__robotGuideTask__postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(MoteC__robotGuideTask);
#line 56
...
#line 56
inline static error_t MoteC__stopGuideTask__postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(MoteC__stopGuideTask);
#line 56
...
#line 56
inline static error_t MoteC__sendNetTask__postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(MoteC__sendNetTask);
#line 56
...
inline static void MoteC__Timer0__stop(void ){
#line 67
...
# 81 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static bool MoteC__Timer0__isRunning(void ){
#line 81
  unsigned char __nesc_result;
#line 81
...
#line 119
{
  if (inVal > -95.0 && inVal < -5.0) {
      float iRange = -5.0 - -95.0;
      float oRange = omax - omin;
      float multFac = oRange / iRange;
      float num = -5.0 * omin - omax * -95.0;
...
#line 113
{
  float actdBm = (float )dBmVal - 45.0;
  float scaledBm = MoteC__scaleValues(actdBm, 1.0, 0.0);

#line 116
  MoteC__newselfPG = pgVal * scaledBm;
}
...
inline static uint8_t MoteC__CC2420Packet__getLqi(message_t *p_msg){
#line 72
  unsigned char __nesc_result;
#line 72
...
inline static int8_t MoteC__CC2420Packet__getRssi(message_t *p_msg){
#line 64
...
#line 181
  ...
  if (len != msgSize) {
      MoteC__Leds__led0Toggle();
      return bufPtr;
    }
  rsm = (radio_msg_t *)payload;
  type = __nesc_ntoh_uint8(rsm->msgType.data);
  switch (type) {
      case 1: 
        gp = __nesc_ntoh_uint8(rsm->srcGP.data);
      switch (gp) {
          case 1: 
            hopCnt = __nesc_ntoh_uint8(rsm->hopCnt.data);
          if (hopCnt < MoteC__selfHC) {
              { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 197
                {
#line 197
                  MoteC__selfHC = hopCnt + 1;
                }
#line 198
                __nesc_atomic_end(__nesc_atomic); }
#line 198
              ...
              netPG = * (float *)&temp;
              netDBM = MoteC__CC2420Packet__getRssi(bufPtr);
              netLQI = MoteC__CC2420Packet__getLqi(bufPtr);
              MoteC__doPGCalculation(netPG, netDBM);
              if (MoteC__newselfPG > MoteC__selfPG) {
                  if (MoteC__Timer0__isRunning()) {
#line 204
                      MoteC__Timer0__stop();
                    }
#line 205
...
#line 205
                    {
#line 205
                      MoteC__selfPG = MoteC__newselfPG;
                    }
#line 206
                    __nesc_atomic_end(__nesc_atomic); }
#line 206
                  MoteC__sendNetTask__postTask();
                }
            }
          break;
          case 2: 
            id = __nesc_ntoh_uint8(rsm->srcID.data);
          if (id == 0) {
              msg = __nesc_ntoh_uint8(rsm->lQi.data);
              if (msg == 3) {
                  MoteC__sendNetTask__postTask();
                }
            }
      ...
      id = __nesc_ntoh_uint8(rsm->srcID.data);
      if (gp == 2 && id == 0) {
          if (__nesc_ntoh_uint8(rsm->lQi.data) == 2) {
              MoteC__stopGuideTask__postTask();
            }
          else {
#line 231
            if (__nesc_ntoh_uint8(rsm->srcNode.data) == TOS_NODE_ID) {
                MoteC__GBL_info = __nesc_ntoh_uint8(rsm->lQi.data);
                MoteC__robotGuideTask__postTask();
              }
            }
        }
#line 236
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x7d919ba8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x7d919ba8) {
#line 67
    case 9:
#line 67
      __nesc_result = MoteC__Receive__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x7d919ba8, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x7dd922a8){
#line 92
  switch (arg_0x7dd922a8) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x7dd922a8);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x7dc4ccf0){
#line 92
  switch (arg_0x7dc4ccf0) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x7dc4ccf0);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x7dd91820, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x7dd91820) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x7dd91820, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x7de7c828, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x7de7c828) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x7de7c828, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x7d9162e8, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x7d9162e8, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x7de7c828, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x7de7c828) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x7de7c828, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x7de80db8){
#line 92
  switch (arg_0x7de80db8) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x7de80db8);
#line 92
      break;
#line 92
    }
...
#line 89
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x7d9191e8, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7d9191e8, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
#line 117
  MoteC__RadioControl__stopDone(error);
#line 117
}
#line 117
...
#line 92
  MoteC__RadioControl__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  MoteC__AMSend__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7e21dd90, message_t * msg, error_t error){
#line 89
  switch (arg_0x7e21dd90) {
#line 89
    case 0U:
#line 89
      /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7e21dd90, msg, error);
#line 89
      break;
#line 89
    }
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x7d877940){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  switch (arg_0x7d877940) {
#line 118
    case /*UARTByteStringConfig.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x7d877940);
#line 118
      break;
#line 118
    }
...
# 8 "../../newUART/UARTByteString.nc"
inline static error_t MoteC__UARTByteString__sendByte(uint8_t data){
#line 8
  unsigned char __nesc_result;
#line 8
...
#line 110
  error = MoteC__UARTByteString__sendByte(data);
}
...
inline static void MoteC__Leds__led1Toggle(void ){
#line 72
...
#line 72
# 67 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void MoteC__Timer1__stop(void ){
#line 67
...
#line 67
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7e219790, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x7e219790, addr, msg, len);
#line 69
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
inline static void /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 9);
  return /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}

# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t MoteC__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*MoteConfig.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 69
...
# 56 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Packet.nc"
inline static void MoteC__CC2420Packet__setPower(message_t *p_msg, uint8_t power){
#line 56
...
inline static uint8_t MoteC__Packet__maxPayloadLength(void ){
#line 95
  unsigned char __nesc_result;
#line 95
...
# 115 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
inline static void * MoteC__Packet__getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 136
    {
      rsm = (radio_msg_t *)MoteC__Packet__getPayload(&MoteC__packet, sizeof(radio_msg_t ));
      if (rsm == (void *)0) {
          return;
        }
      if (MoteC__Packet__maxPayloadLength() < sizeof(radio_msg_t )) {
#line 141
          return;
        }
#line 142
      switch (type) {
          ...
          __nesc_hton_uint8(rsm->srcGP.data, 1);
          break;
          case 10: 
            __nesc_hton_uint8(rsm->msgType.data, 2);
          __nesc_hton_uint8(rsm->srcGP.data, 1);
          break;
        }
      __nesc_hton_uint8(rsm->srcNode.data, TOS_NODE_ID);
      __nesc_hton_uint8(rsm->srcID.data, 5);
      __nesc_hton_uint8(rsm->hopCnt.data, MoteC__selfHC);
      __nesc_hton_uint32(rsm->pgVal.data, pgVal);
      __nesc_hton_int8(rsm->dBmVal.data, 100);
      __nesc_hton_uint8(rsm->lQi.data, 100);
      __nesc_hton_uint8(rsm->numMsgs.data, MoteC__guideCtr);
      MoteC__CC2420Packet__setPower(&MoteC__packet, 3);
      if (MoteC__AMSend__send(AM_BROADCAST_ADDR, &MoteC__packet, sizeof(radio_msg_t )) == SUCCESS) {
#line 160
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 160
            {
...
# 81 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static bool MoteC__Timer1__isRunning(void ){
#line 81
  unsigned char __nesc_result;
#line 81
...
#line 250
{
  switch (MoteC__doFlag2) {
      case 10: 
        if (MoteC__guideCtr >= MoteC__GBL_XmitCnt) {

            if (MoteC__Timer1__isRunning()) {
#line 255
                MoteC__Timer1__stop();
              }
          }
...
#line 261
      break;
      case 9: 
        if (MoteC__uartPtr >= 100) {
            MoteC__Timer1__stop();
          }
        else 
#line 265
          {
            MoteC__Leds__led1Toggle();
            MoteC__CommSendUART(MoteC__UartBuf[MoteC__uartPtr]);
          }
      { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 269
        {
...
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7e2ced90){
#line 72
  switch (arg_0x7e2ced90) {
#line 72
    case 0U:
#line 72
      MoteC__Timer0__fired();
#line 72
      break;
#line 72
    case 1U:
#line 72
      MoteC__Timer1__fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7e2ced90);
#line 72
      break;
#line 72
    }
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void MoteC__Timer1__startPeriodic(uint32_t dt){
#line 53
...
#line 96
{
  MoteC__uartPtr = 0;
  MoteC__doFlag2 = 9;
  MoteC__Timer1__startPeriodic(10);
}
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void MoteC__Timer1__startOneShot(uint32_t dt){
#line 62
...
#line 49
{
  MoteC__doFlag2 = 10;
  MoteC__guideCtr = 0;
  MoteC__numPktsInfo = (MoteC__GBL_info & 0xF0) >> 4;
  MoteC__pktTimeInfo = MoteC__GBL_info & 0x0F;
  switch (MoteC__numPktsInfo) {
      case 1: 
        MoteC__GBL_XmitCnt = 25;
      break;
      case 2: 
        MoteC__GBL_XmitCnt = 50;
      break;
      case 3: 
        MoteC__GBL_XmitCnt = 100;
      break;
      case 4: 
        MoteC__GBL_XmitCnt = 150;
      break;
      case 5: 
        MoteC__GBL_XmitCnt = 200;
      break;
    }
  switch (MoteC__pktTimeInfo) {
      case 1: 
        MoteC__GBL_intpktTime = 50;
      break;
      case 2: 
        MoteC__GBL_intpktTime = 100;
      break;
      case 3: 
        MoteC__GBL_intpktTime = 200;
      break;
      case 4: 
        MoteC__GBL_intpktTime = 400;
      break;
      case 5: 
        MoteC__GBL_intpktTime = 500;
      break;
    }
  MoteC__Timer1__startOneShot(500);
}
...
{
  MoteC__doFlag1 = 8;
  MoteC__Timer0__startOneShot(10 * TOS_NODE_ID + 1);
}
...
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t MoteC__RadioControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
inline static void MoteC__Leds__led2Toggle(void ){
#line 89
...
# 41 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430Interrupt.nc"
inline static void MoteC__HplMsp430Interrupt__clear(void ){
#line 41
...
# 36 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430Interrupt.nc"
inline static void MoteC__HplMsp430Interrupt__disable(void ){
#line 36
...
#line 285
{
  MoteC__HplMsp430Interrupt__disable();
  MoteC__HplMsp430Interrupt__clear();
  MoteC__Leds__led2Toggle();
  /* atomic removed: atomic calls only */
#line 289
  {
#line 289
    MoteC__selfHC = TOS_NODE_ID;
  }
  /* atomic removed: atomic calls only */
#line 290
  {
#line 290
    MoteC__selfPG = 1000.0 / TOS_NODE_ID;
  }
#line 291
  MoteC__Timer0__startOneShot(500 * 2);
}

# 61 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430Interrupt.nc"
inline static void HplMsp430InterruptP__Port27__fired(void ){
#line 61
  MoteC__HplMsp430Interrupt__fired();
#line 61
}
#line 61
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x7dc813d0, uint8_t data){
#line 54
  switch (arg_0x7dc813d0) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x7dc813d0, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0x7dc81c50){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0x7dc81c50);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x7dc813d0){
#line 49
  switch (arg_0x7dc813d0) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x7dc813d0);
#line 49
      break;
#line 49
    }
...
#line 10
  MoteC__UARTByteString__receiveByteDone(data, error);
#line 10
}
#line 10
...
# 79 "/opt/tinyos-2.x/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x7d878558, uint8_t byte){
#line 79
  switch (arg_0x7d878558) {
#line 79
    case /*UARTByteStringConfig.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x7d878558, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x7d878558, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x7d878558) {
#line 99
    case /*UARTByteStringConfig.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x7d878558, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x7dc813d0, uint8_t data){
#line 54
  switch (arg_0x7dc813d0) {
#line 54
    case /*UARTByteStringConfig.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x7dc813d0, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x7d878558, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x7d878558) {
#line 57
    case /*UARTByteStringConfig.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x7d878558, buf, len, error);
#line 57
      break;
#line 57
    }
...
# 49 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x7dc813d0){
#line 49
  switch (arg_0x7dc813d0) {
#line 49
    case /*UARTByteStringConfig.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x7dc813d0);
#line 49
      break;
#line 49
    }
...
#line 64
    case MoteC__sendNetTask:
#line 64
      MoteC__sendNetTask__runTask();
#line 64
      break;
#line 64
    case MoteC__robotGuideTask:
#line 64
      MoteC__robotGuideTask__runTask();
#line 64
      break;
#line 64
    case MoteC__stopGuideTask:
#line 64
      MoteC__stopGuideTask__runTask();
#line 64
      break;
#line 64
    case MoteC__uartSendTask:
#line 64
      MoteC__uartSendTask__runTask();
#line 64
      break;
#line 64
...
#line 242
{
  if (&MoteC__packet == bufPtr) {
      MoteC__Leds__led2Toggle();
      MoteC__locked = FALSE;
      MoteC__Timer1__startOneShot(MoteC__GBL_intpktTime);
    }
}
